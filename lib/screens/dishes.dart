...
//Product (dishes) class

class Dishes extends StatefulWidget {
  const Dishes({Key? key, required this.cart}) : super(key: key);
...
class _DishesState extends State<Dishes> with ChangeNotifier {
  late List<Product> _dishes;

  @override
  void initState() {
    super.initState();
    _dishes = Utils().populateDishes();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text('Dishes', style: TextStyle(fontFamily: 'Lobster')),
          actions: [
            Padding(
